...
//                            });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.menu_item_check_version) {
            //用户指南
            ...
            new AlertDialog.Builder(this)
                    ...
                    .show();
            return true;
        } else if (id == R.id.menu_item_proxy) {
            AlertDialog.Builder builder = new AlertDialog.Builder(this);
            builder.setTitle(getString(R.string.proxy_setting));
            ...
            textView1.setText(getString(R.string.proxy_setting_textView1));
    ...
    */
            ...
            builder.setNeutralButton(getString(R.string.btn_dlt), (dialog, which) -> {
            ...
            if ((Boolean) result) {
                ...
                this.runOnUiThread(() -> {
                    new AlertDialog.Builder(context)
                            .setTitle(getString(R.string.app_name) + " " + getVersionName())
                            .setMessage(getString(R.string.acc_save_success))
                            .setPositiveButton(R.string.btn_ok, null)
                            .show();
                });
            }
    ...
    private void showInvalidAccountDialog() {
        this.runOnUiThread(() -> {
            new AlertDialog.Builder(this)
                    .setTitle(getString(R.string.app_name) + " " + getVersionName())
                    .setMessage(getString(R.string.acc_save_failed))
                    .setPositiveButton(R.string.btn_ok, null)
                    .show();
        });
    }
